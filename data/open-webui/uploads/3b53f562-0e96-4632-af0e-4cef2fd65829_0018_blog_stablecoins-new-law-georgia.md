<!-- source: https://pbservices.ge/blog/stablecoins-new-law-georgia/ -->

[Homepage](https://pbservices.ge)/[Finance and Investment](https://pbservices.ge/blog/finance-investment/)/
# Who has the right to issue stablecoins under Georgia’s new law?
The simple answer: companies with a VASP license and capital of at least GEL 500,000. We discuss other regulatory requirements and the significance of the new regulation for the cryptocurrency market.
[Finance and Investment](https://pbservices.ge/blog/finance-investment/)
Reading time: 5 min
/
20 May, 2026
![Who has the right to issue stablecoins under Georgia’s new law](https://pbservices.ge/wp-content/uploads/2026/05/georgias-new-stablecoin-law-1024x512.jpg)
Table of contents
## **Legislative Framework**
On March 6, 2026, the Governor of the National Bank of Georgia signed[ Order No. 52/04](https://matsne.gov.ge/ka/document/view/6807568?publication=0) _On the Approval of the Rules for the Initial Coin Offering of a Stablecoin by a Virtual Asset Service Provider_ , which complements previous government initiatives to legalize cryptocurrency, pegging stablecoins to local or foreign currency and establishing clear requirements for companies that would like to issue them.
...
The simple answer is: companies with a _Virtual Asset Service Provider_ ([VASP](https://pbservices.ge/services/crypto-license-georgia/)) license. The National Bank introduced this category of legal entities back in 2023, granting them the right to work with crypto. We wrote about obtaining a VASP license (and GeCrypto)[ in a separate article](https://pbservices.ge/blog/gecrypto-how-to-get-a-crypto-license-in-georgia/).
...
Even fintech startups satisfying the requirements must first **coordinate with the National Bank of Georgia** before being allowed to organize an initial coin offering (ICO) and launch advertising for the asset by:
  1. Drafting a White Paper with information about the company, the characteristics of the asset, technological architecture, and risks. The document must be published on the official website for public access.
  2. Completing an operational risk assessment form according to the Basel Committee methodology.
  3. Developing cybersecurity and risk management policies and obtain an independent audit opinion on the systems’ compliance with national criteria.
  4. Choosing a commercial bank where the reserves will be stored (requires separate approval).
  5. Providing the regulator with a package of documents and other sensitive information.
...
PB Services can help you register a company in Georgia and obtain a VASP license, handle reporting, and ensure your cryptocurrency business does everything above board. Drop us a line to sign up[for a free consultation](https://pbservices.ge/free-consultation/).
