<!-- source: https://pbservices.ge/blog/corporate-income-tax-in-georgia/ -->

[Skip to content](https://pbservices.ge/blog/corporate-income-tax-in-georgia/#gspb_row-id-gsbp-0d5ef8f)
...
/
14 June, 2026
![Income Tax In Georgia](https://pbservices.ge/wp-content/uploads/2026/06/income-tax-in-georgia-1024x512.jpg)
Table of contents
## Corporate Income Tax in Georgia: Quick Overview
Corporate income tax in Georgia is generally 15%. Georgia uses an Estonian-style corporate tax model, meaning that most companies do not pay corporate income tax on retained or reinvested profits. Tax is mainly triggered when profits are distributed, such as through dividends, or when certain expenses are treated as profit distributions. Some companies may qualify for reduced rates, including 5% for International Company status or 0% for certain Virtual Zone, Free Industrial Zone, and special trading activities.
  * **Standard CIT rate:** 15%
  * **Main tax trigger:** distribution of profit
  * **Retained/reinvested profits:** generally not taxed
  * **Financial institutions:** generally 20% on annual net profit
  * **International Company status:** 5% in qualifying cases
  * **Virtual Zone / FIZ:** 0% in qualifying cases
  * **Dividend withholding tax:** generally 5%
  * **Filing/payment deadline:** by the 15th day of the following month

To understand all the nuances, we propose taking a closer look at the provisions of the [Tax Code](https://matsne.gov.ge/ka/document/view/1043717?publication=242#!) of Georgia that pertain to profit tax (also known as corporate income tax) and the related topic of withholding tax.
...
| **Status**  | **Profit distribution**  | **Non-business expenses**  | **Free supplies**  | **Entertainment expenses exceeding the limit**  |  
| --- | --- | --- | --- | --- |  
| [Ordinary company](https://pbservices.ge/services/company-registration-georgia/)  | 15%  | 15%  | 15%  | 15%  |  
| [International IT company](https://pbservices.ge/services/international-it-company/)  | 5%  | 5%  | 5%  | 5%  |  
| [Virtual zone participant](https://pbservices.ge/services/it-virtual-zone-company-georgia/)  | 0% (on profit from IT services exports)  | 15%  | 15%  | 15%  |  
| [Participant in a free industrial zone](https://pbservices.ge/services/free-zones-georgia/)  | 0% (on profit from permitted activities)  | 0%  | 0%  | 0%  |  
| Special trading company  | 0% (on profit from permitted activities)  | 15%  | 15%  | 15%  |  
| Investment fund  | 5% or 15% (depending on the type of investment)  | 0%  | 0%  | 0%  |  
...
If, however, the profit is distributed to a resident company (which itself does not fall into any of the preferential categories and pays non-zero profit tax), no tax is dueu003c/strongu003e.
...
###  **_What qualifies as_**** _profit distribution_**
...
If the payments are made to a non-resident from a country with which a double taxation agreement has been signed (though the possibility of reducing the tax rate to as low as 0% depends on the specific agreement—this method does not work for some countries). [We wrote about double taxation agreements](https://pbservices.ge/blog/georgia-double-taxation-and-expats/) in detail [on our blog](https://pbservices.ge/blog/georgia-double-taxation-and-expats/).
Withholding tax applies in at least one other situation not related to profit distribution—when a company pays royalties to non-resident contractors. In this case, the rate is 10% and may be reduced to 0% through double taxation agreements.
...
Important tip: Before classifying an expense as non-business-related, the accountant should assess whether it constitutes a benefit to the employee and refer to the provisions of the Tax Code regarding wages.
...
No liability arises if gratuitous supplies are made to a non-resident company (provided it is not exempt from income tax). Exceptions include free supplies to government agencies and municipalities, as well as the transfer of assets within the framework of projects ratified by international agreements.
...
_Of course, income tax is not the only obligation companies face in Georgia. Read about other taxes_[ _in our general guide_](https://pbservices.ge/blog/tax-guide-companies-georgia/) _._
...
### Related articles
  * #### [VAT in Georgia: Expert Guide to Charge, Claims, and Payments](https://pbservices.ge/blog/vat-in-georgia/)
14 June, 2026
[](https://pbservices.ge/blog/vat-in-georgia/ "VAT in Georgia: Expert Guide to Charge, Claims, and Payments")
