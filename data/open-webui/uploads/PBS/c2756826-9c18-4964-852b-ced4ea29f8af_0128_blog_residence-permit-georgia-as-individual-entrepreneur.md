<!-- source: https://pbservices.ge/blog/residence-permit-georgia-as-individual-entrepreneur/ -->
...
A residence permit as individual entrepreneur in Georgia allows an entrepreneur to:
  ...
  * Only the residents of the country get so called **electronic state signature**. With this signature they are able to receive most of the state services remotely using the portal my.gov.ge
...
The authorities may request additional documents. The House of Justice will issue a confirmation that the application has been accepted for consideration. At the top of the document are written its number and code, and they can be entered on [their website](https://sda.gov.ge/?page_id=13122&lang=en) to track the status of the application .
...
## Final comments
Starting from 2022, the residence permit has started to be denied for citizens of some countries, on the grounds specified in the [Georgian law](https://matsne.gov.ge/ru/document/download/2278806/4/ru/pdf):
...
Contact our experts to get a [residence permit as individual entrepreneur](https://pbservices.ge/services/individual-entrepreneur-georgia/) quickly and easily.
« [How to open easily a business in Georgia](https://pbservices.ge/blog/how-to-open-easily-business-georgia/)
» [Getting a Crypto License in Georgia in 2023](https://pbservices.ge/blog/getting-crypto-license-in-georgia/)
