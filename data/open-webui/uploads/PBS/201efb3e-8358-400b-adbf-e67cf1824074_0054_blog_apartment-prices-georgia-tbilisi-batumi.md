<!-- source: https://pbservices.ge/blog/apartment-prices-georgia-tbilisi-batumi/ -->

[Homepage](https://pbservices.ge)/[Real Estate](https://pbservices.ge/blog/real-estate/)/
# Apartment prices in Georgia: Tbilisi, Batumi, and elsewhere
A one-bedroom apartment will generally set you back about USD 85,000 in the capital, with spacious premium-class housing going for at least USD 200,000. Prices are a bit lower on the Black Sea coast and in the country’s major ski resorts, with budget options available in Kutaisi and Rustavi.
[Real Estate](https://pbservices.ge/blog/real-estate/)
Reading time: 6 min
/
23 January, 2026
![Guide to real estate prices in Georgia](https://pbservices.ge/wp-content/uploads/2025/04/apartment-prices-in-georgia-1024x512.webp)
Table of contents
...
Upwards of 60,000 purchases of residential real estate are made in Georgia every year, approximately 72%, according to TBC Capital estimates, in Tbilisi, 20% in Batumi, and the remaining 8% in other cities like Rustavi and Kutaisi, all major centers by Georgian standards:
  ...
  * _Other hidden gems include Telavi, Kobuleti, Bakuriani, Gudauri, Borjomi, Gori, and Mtskheta, each with its own advantages, though possibly fewer options for real estate. Below is a map of building density, with each point a housing project recently built or under construction._

The most active development can be seen in Tbilisi and along the coast of the Black Sea
...
Popular Tbilisi neighborhoods with average cost of housing by color
**The price also depends on the class of housing (with premium housing at least twice as expensive) and the district**. Officially, there are 30+ administrative districts in Tbilisi, combined for convenience into several larger ones. We [talked about ](https://pbservices.ge/blog/tbilisi-neighborhoods/)them in more detail in the blog. Some highlights:
...
Sign up for an in-depth look at the Georgian real estate market with the experts at PB Services. We will help you find the property best suited to your needs and handle all the paperwork. Read more about how we can help you [here](https://pbservices.ge/real-estate-georgia/).
**AVERAGE FOR TBILISI**  
...
Cost per square meter in Batumi municipality
...
## Other cities for _je (ne) sais quoi_
...
Real estate prices in Batumi, Bakuriani, Kobuleti, and Gudauri in the third quarter of 2024
## Georgia is ready for foreign investors
  ...
  * _If you stay in the country to work and register as an IE with small business status, a popular choice among freelancers and employees of foreign companies, tax on the income from labor is only 1%. We have_[ _written elsewhere_](https://pbservices.ge/blog/tax-guide-companies-georgia/) _about the tax advantages that exist for start-ups_
...
Why not catch the market on the way up? PB Services can help you find the perfect apartment and handle the paperwork and payments. Contact us with the form below or request a [free consultation](https://pbservices.ge/free-consultation/).
« [Getting a mortgage in Georgia: conditions and documents](https://pbservices.ge/blog/getting-a-mortgage-in-georgia/)
» [US-China Tariffs: why Georgia is ideal for Chinese businesses](https://pbservices.ge/blog/trade-alternative-for-chinese-businesses/)
