<!-- source: https://pbservices.ge/blog/individual-property-taxes-georgia-guide/ -->
...
/
20 February, 2025
![Property Tax](https://pbservices.ge/wp-content/uploads/2023/02/property-tax-3-1024x576.jpg)
Table of contents
...
**Bad News** : _You are subject to multiple possible taxes after you become owner of a real estate property in Georgia._
**Good News** : _Taxes are low and easy to administrate_
...
There are two scenarios with which different rates of income tax are applied. Scenarios are different whether you rent your real estate to an _i_** _ndividual_** (mostly for living purposes) or a **_business_** (mostly as office).
