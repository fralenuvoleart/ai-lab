<!-- source: https://pbservices.ge/blog/tax-guide-companies-georgia/ -->

[Homepage](https://pbservices.ge)/[Law & Taxes](https://pbservices.ge/blog/law-taxes/)/
# A guide to the taxes companies pay in Georgia
There are six main taxes in the country. Key for business: VAT, corporate, and income taxes (including on dividends).
[Law & Taxes](https://pbservices.ge/blog/law-taxes/)
Reading time: 8 min
/
13 November, 2025
![Guide to the taxes](https://pbservices.ge/wp-content/uploads/2025/01/taxes-guide-1024x683.jpg)
Table of contents
According to the National Statistics Service (Geostat), there were more than 270,000 active businesses registered in Georgia as of October 1, 2024, and [almost 16%](https://www.geostat.ge/en/modules/categories/66/by-ownership-type) were owned by foreigners. Most of those are likely [IE with small business status](https://pbservices.ge/services/individual-entrepreneur-georgia/) paying only 1% on turnover.
As for larger companies and startups – we wrote previously about the [legal forms of limited liability companies (LLC)](https://pbservices.ge/blog/why-businesses-are-successful-in-tbilisi-georgia/), jointly and severally liable companies (JLC), and joint stock companies (JSC), as well as limited liability companies and cooperatives (a less common choice). The tax burden in Georgia is relatively low for all – the country levies some of the lowest taxes in the world, and sometimes none at all (!).
## Taxes in Georgia
...
The easiest way is to get special favorable tax status:
  * Organizations that have been engaged in information technology for more than two years (in Georgia or abroad, though in the second case, the controlling interest must be owned by the foreign partner) can be recognized as[ an international IT company](https://pbservices.ge/services/international-it-company/), automatically reducing VAT to 0% and corporate and income tax to 5% with no need to withhold anything when distributing profits
  * Any IT business can become a member of the virtual zone, exempt from VAT and corporate tax – for more detail on how to become a participant in such a zone, _check this out_

Registration in a [free](https://pbservices.ge/services/free-zones-georgia/) industrial zone (Tbilisi, Kutaisi, Poti) exempts you from five of the six taxes listed above (including excise and import tax) but not income tax (PIT), which remains at 20%
**To learn more about special tax regimes, sign up for a totally free[30-minute consultation](https://pbservices.ge/free-consultation/) with a PB Services specialist. We can help you find the tax regime best suited to your business, help you open a company, and take you through all the legal procedures.**
...
**And just a reminder: members of free and virtual zones are exempt from CIT when exporting their services and goods abroad.**[**International IT companies**](https://pbservices.ge/blog/it-company-in-georgia-an-international-company-status/)**pay 5%**.
...
[](https://pbservices.ge/wp-content/uploads/2025/01/primer-rascheta-korporativnogo-naloga-cit.png)primer rascheta korporativnogo naloga cit
...
Everyone – regardless of residency – pays tax on income received from a source in Georgia (in our case – from a Georgian company). It is often the customer/employer who becomes the tax agent, but:
  ...
  * **a non-resident contractor** is subject to “withholding tax” instead of income tax, at 10%_, though it can be reduced to 0% if there is a double taxation agreement between Georgia and the employee’s country of residence_
...
**Although a living wage has not been officially defined in Georgia, the Georgia Fair Labor Platform places it at GEL[1,858](https://shroma.ge/en/living-wage-en/)/month. To provide this amount, the actual salary must be about GEL 2,370 before the deduction of 20% and pension contributions.**
## Value added tax
...
The Ministry of Finance has a [separate website](https://nr.rs.ge/home) for foreign companies with guidance on declaring and paying VAT.
## What is reverse VAT?
If an organization works with foreign contractors (which are almost uncontrollable for tax regulators), it has an obligation to declare reverse VAT (_also called refundable_ VAT) of 18%. At the same time, Article 176 of the Tax Code of Georgia explicitly states that if a company is registered as a value added tax payer, it can offset reverse VAT immediately at the moment it is reflected in the declaration, i.e. it is not actually required to pay it.
...
[](https://pbservices.ge/wp-content/uploads/2025/01/primery-stavok-nds.png)
## Property tax
...
In addition, a separate land tax is levied if a company owns land. The rate depends on the size of the plot and the region (check out the exact figures [here](https://www.rs.ge/LandCalculator) when filing the relevant declaration or using the online calculator).
...
## Excise and import tax
  * **There is excise tax on imports**(but not exports) of alcoholic beverages, tobacco products, liquefied natural gas, crude oil products, and automobiles. The rate varies from GEL 0.6 to 800 per unit of goods. Details can be found in _Articles 182 et seq. of the Tax Code of Georgia_.
  * **Import tax**(aka customs duty) is levied on goods when they cross the border. The full list of goods is _in Article 197 of the Tax Code_. In particular, the tax rate is 12% when importing many food products, construction materials, jewelry. The rate of 5% applies to cheese and cottage cheese, a number of cosmetics, and clothing. There is a different formula for cars (in addition to excise duty): GEL 0.05 for each cm³ of engine volume plus 5% of this amount for each year of operation. Goods imported for humanitarian aid or financed by grants are exempt from tax.
...
**There are some finer points that have not made it into this article, and at the end of the day – your tax obligations depend on your company activities. To make your reporting crystal clear, you can[outsource your accounting](https://pbservices.ge/services/accounting-services-georgia/). PB Services can help you get any business documents in order and organize the work of your [HR-department](https://pbservices.ge/services/hr-outsourcing-georgia/).**
« [Georgia’s IT virtual zone. Can you get these tax benefits?](https://pbservices.ge/blog/georgia-it-virtual-zone-tax-benefits/)
