<!-- source: https://pbservices.ge/blog/gecrypto-how-to-get-a-crypto-license-in-georgia/ -->

[Skip to content](https://pbservices.ge/blog/gecrypto-how-to-get-a-crypto-license-in-georgia/#gspb_row-id-gsbp-0d5ef8f)
[Homepage](https://pbservices.ge)/[Company Registration](https://pbservices.ge/blog/company-registration/)/
# GeCrypto: how to get a crypto license in Georgia (and corner 20% of the market in six months)
One of the first to obtain virtual asset service provider status was a local Tbilisi company, who did it all with the help of the lawyers at PB Services, who drew up the business plan and AML policy.
[Company Registration](https://pbservices.ge/blog/company-registration/)
Reading time: 3 min
/
12 June, 2026
![how to get a crypto license in Georgia](https://pbservices.ge/wp-content/uploads/2025/06/gecrypto-1024x512.webp)
Table of contents
Those heady first days of crypto’s Wild West have ridden off into the sunset as regulatory restrictions tighten everywhere, and Georgia is no exception. Since 2023, companies working with digital assets for the benefit of third parties have had to register with the National Bank of Georgia as a _VASP (Virtual Asset Service Provider)_. Otherwise known simply as a cryptolicense, it guarantees a business’ principled rejection of money laundering and all things illegal.
...
The next step, no less important, entails the gathering of documents. In total, **more than 10 documents need to be notarized or apostilled** (we cover this list [in more detail here)](https://pbservices.ge/blog/getting-crypto-license-in-georgia/). 
The main points:
...
PB Services provides full support – [turnkey support for VASP registration](https://pbservices.ge/services/crypto-license-georgia/), something GeCrypto only found out after actually talking to us.
...
GeCrypto received its final VASP status (_identification number_ 405607400) on October 16, 2024, the 18th company to join Georgia’s list of virtual asset service providers (ByBit received its license a few days later). In November, the company began operating.
If you’ve been considering the cryptocurrency industry, we can [help you obtain a VASP license in Georgia](https://pbservices.ge/service/crypto-license-georgia/). Important: **client confidentiality comes first**.
...
For more information about GeCrypto, check out [their website](https://gecrypto.com/).
...
« [The hows and whys of investing in commercial real estate in Georgia](https://pbservices.ge/blog/hows-investing-in-commercial-real-estate-in-georgia/)
