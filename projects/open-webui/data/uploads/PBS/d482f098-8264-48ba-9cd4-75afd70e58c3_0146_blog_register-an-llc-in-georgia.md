<!-- source: https://pbservices.ge/blog/register-an-llc-in-georgia/ -->
...
/
20 February, 2025
![Register an LLC in Georgia](https://pbservices.ge/wp-content/uploads/2021/10/register-llc-georgia-1024x590.jpg)
Table of contents
...
It is called the Law on Enterprises, and you can find it [here](https://matsne.gov.ge/en/document/download/28408/49/ru/pdf).
...
What you can’t get there is electronic payment status and VAT registration, which you still need to apply for to the Revenue Service (more detailed information available [here](https://www.rs.ge)).
...
The documents, articles of association, and other company information remain in open access in the public domain and can be found [here](https://enreg.reestri.gov.ge), where you enter initial company information (identification number, name, etc.).
Georgian legislation makes no requirements for minimum capital, which greatly simplifies the registration of an LLC.
Another advantage to [registering an LLC in Georgia](https://pbservices.ge/services/company-registration-georgia/) is that the company may be headed by anyone regardless of citizenship (whether Georgia or foreign).
...
###  **W****hat****are****the advantage****s****of registering an LLC in Georgia?**
...
### **What does taxation of an LLC in Georgia look like?**
  * Corporate tax on distributed profits – 15%. Georgia employs the so-called **Estonian****Income Tax** **M****odel** , which means that you only pay taxes if you distribute the profits in the form of dividends. If you (a) leave your profit in the company or b) reinvest the profit, then **your profits****are not****taxed at all****.**
  * Dividend tax – 5%
  * VAT – 18%
