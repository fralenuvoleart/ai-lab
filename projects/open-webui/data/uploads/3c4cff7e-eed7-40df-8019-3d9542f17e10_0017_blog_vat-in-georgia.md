<!-- source: https://pbservices.ge/blog/vat-in-georgia/ -->

[Skip to content](https://pbservices.ge/blog/vat-in-georgia/#gspb_row-id-gsbp-0d5ef8f)
[Homepage](https://pbservices.ge)/[Law & Taxes](https://pbservices.ge/blog/law-taxes/)/
# VAT in Georgia: Expert Guide to Charge, Claims, and Payments
...
/
14 June, 2026
![Everything You Wanted to Know About VAT in Georgia](https://pbservices.ge/wp-content/uploads/2026/05/vat-in-georgia-1024x512.jpg)
Table of contents
## VAT in Georgia: Quick Summary
  * **Standard VAT Rate:** The standard Value Added Tax (VAT) rate in Georgia is a flat **18%**.
  * **Mandatory Registration Threshold:** Businesses must register for VAT if their taxable turnover exceeds **100,000 GEL** over any continuous 12-month period. Registration must be completed within 2 days of crossing the threshold.
  * **Voluntary Registration:** Companies can register for VAT voluntarily at any time, regardless of turnover, to claim input VAT deductions.
  * **Zero-Rated VAT (0%):** The export of goods and services (including IT service exports by International Companies or Virtual Zone entities) is **zero-rated (0% VAT)** with the right to deduct input VAT.
  * **Filing and Payment Deadlines:** VAT declarations must be submitted and paid on a monthly basis, by the **15th day of the following month**.
...
**Note:** You can cancel your VAT payer status voluntarily no earlier than 12 months after registering, provided the total amount of taxable transactions at that moment does not exceed GEL 100,000.
## VAT exemptions
...
**Summary:** Work with foreign companies and individuals within the scope of this list requires no VAT of Georgian businesses
At the same time, the Tax Code identifies goods and services that are **exempt** from Value Added Tax regardless of the place of transaction (partially overlapping with and complementing the list of exceptions above). They can be divided into two main categories:
  * **Exempt without the right to input VAT deduction (credit):** medical, educational, funeral, and financial services, as well as the supply of land plots and paper products such as newspapers, magazines, and sheet music. As an exception, transactions between participants in [Georgian Free Industrial Zones](https://pbservices.ge/blog/free-zones-in-georgia-difference/) are also exempt without the right to deduction.
...
The law also refers to transactions that **are not recognized as supply and are not considered subject to VAT**. These include the transfer of funds and cryptocurrency, the transfer of assets between participants in a reorganization, the transfer of all assets or an entire independent enterprise from one VAT entity to another, as well as contributions to an organization’s capital (_note that despite being exempt from the tax, the latter case may give rise to an obligation to register the company as a VAT payer—as described in the previous section_).
**Interesting Fact:** A company or individual can choose to pay VAT on financial or land supplies that qualify for an exemption in order to preserve their right to input tax deductions. Furthermore, specific situations cannot be ruled out where the Revenue Service might oblige a business to calculate VAT even on exempt categories—for instance, if the sale of goods occurs within bankruptcy proceedings or if the regulator suspects tax evasion.
...
| **Special Status**  | **When VAT = 0%(with the right to deduct VAT expenses)**  | **When VAT = 18%**  |  
| --- | --- | --- |  
| [International IT Companies](https://pbservices.ge/services/international-it-company/)  | Export of IT services within permitted activities  | Supply of goods and services within the territory of Georgia  |  
| [Virtual Zone Persons](https://pbservices.ge/services/it-virtual-zone-company-georgia/)  | Export of software  | Sale of software in Georgia  |  
| [Free Industrial Zone (FIZ) Participants](https://pbservices.ge/services/free-zones-georgia/)  | Export of goods outside Georgia, as well as internal operations within the FIZ with other zone participants (the latter without the right to VAT deductions)  | Such a situation does not arise. If an FIZ participant supplies goods to persons registered in Georgia, they face a unique 4% tax on income from this operation  |  
_* It should be repeated that these benefits stem mostly from general VAT exemptions rather than the specific statuses of the companies. Ordinary LLCs, JSCs, or Individual Entrepreneurs can also count on a 0% rate with the right to deduction if they export goods abroad. However, special regimes still offer advantages regarding other taxes, including corporate income tax and personal income tax. For more details, read_[ _the general article on taxes for businesses in Georgia_](https://pbservices.ge/blog/tax-guide-companies-georgia/) _._
...
_For example, an IT company might generate half of its income from selling software inside Georgia (subject to VAT) and the other half from selling programming educational courses (exempt). In this case, it will only be able to claim a deduction for 50% of the VAT from its rent and utility bills._
...
**_*_**_Free Industrial Zone participants are exempt from reverse-charge VAT regardless of their status._
...
**Note:** The obligation to calculate reverse-charge VAT does not only arise when interacting with non-residents. Similar rules apply to Georgian entities when purchasing goods from FIZ enterprises or at a customs warehouse (import), provided that the goods subsequently enter free circulation.
...
Within the scope of this article, we have reviewed most of the provisions of the Tax Code of Georgia dedicated to VAT and would highlight the following:
  ...
  * For ordinary individuals, it can also sometimes make sense to become a VAT payer: for example, during substantial investments [in commercial real estate](https://pbservices.ge/blog/hows-investing-in-commercial-real-estate-in-georgia/).
...
If you still have questions about VAT or need assistance with company registration, tax accounting, or other matters, contact the specialists at PB Services using the form below. We also offers [outsourced accounting services](https://pbservices.ge/services/accounting-services-georgia/).
...
### Related articles
  * #### [Corporate Income Tax in Georgia: Really Complicated?](https://pbservices.ge/blog/corporate-income-tax-in-georgia/)
14 June, 2026
[](https://pbservices.ge/blog/corporate-income-tax-in-georgia/ "Corporate Income Tax in Georgia: Really Complicated?")
...
[](https://pbservices.ge/blog/a-complete-guide-to-registering-a-logistics-company-in-georgia-2025-2026/ "A Complete Guide to Registering a Logistics Company in Georgia \(2025–2026\)")
  * #### [A Comprehensive Guide to Legalizing Foreign Documents in Georgia](https://pbservices.ge/blog/legalizing-foreign-documents-in-georgia/)
1 May, 2026
[](https://pbservices.ge/blog/legalizing-foreign-documents-in-georgia/ "A Comprehensive Guide to Legalizing Foreign Documents in Georgia")
  * #### [Becoming a tax resident of Georgia without the negative consequences](https://pbservices.ge/blog/tax-resident-of-georgia/)
19 January, 2026
[](https://pbservices.ge/blog/tax-resident-of-georgia/ "Becoming a tax resident of Georgia without the negative consequences")
...
29 November, 2025
[](https://pbservices.ge/blog/precious-metals-in-georgia/ "The tax regime for precious metals in Georgia and getting the most bang for your buck when buying gold")
